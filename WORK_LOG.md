...
Timezone left as UTC (cron `0 2 * * *` UTC = 7 PM PDT / 6 PM PST). Setting `TZ=America/Los_Angeles` to make "2 AM" match Seattle local was discussed and explicitly deferred — current behavior is data refresh in the early evening Seattle time.
