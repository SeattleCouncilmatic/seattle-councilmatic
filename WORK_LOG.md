...
Expected re-parse impact: +3 sections (7,430 → 7,433); -1 `ParseValidationIssue` row (31 → 30, the 23.76.067 row clears; 23.50A.160 and 25.24.030 weren't in PVI because the TOC scanner didn't see them either).
