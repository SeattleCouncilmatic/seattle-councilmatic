...
urlpatterns = [
    ...
    path("api/committees/", api_views.committees_index, name="api_committees_index"),
    path("api/committees/<slug:slug>/", api_views.committee_detail, name="api_committee_detail"),
