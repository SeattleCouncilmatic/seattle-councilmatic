...
CHAT_SYSTEM_PROMPT = (
    ...
    "`[Land Use Committee meeting on 2026-05-11](/events/land-use-...)`, "
    ...
    "same answer can stay plain text. This lets readers click "
    "through to the entity's full Councilmatic page without losing "
