...
export default function LegislationDetail() {
  ...
  return (
    <div className="leg-detail-page">
      <div className="leg-detail-container" id="page-top">
        ...
        <header className="leg-detail-header">
          ...
          {hasSummary && (
            <a className="leg-summary-jump" href="#plain-summary">Go to Plain Summary ↓</a>
          )}
        </header>
        ...
        <div className={`leg-detail-body${
          ...
          {bill.llm_summary && (
            <article id="plain-summary" className="leg-detail-section leg-summary-card leg-card-summary">
              ...
              <a className="leg-summary-jump" href="#page-top">Back to top ↑</a>
